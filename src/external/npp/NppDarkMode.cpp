...
#include "DarkMode.h"  // PapyrusPlugin modification -- DarkMode.h is moved to parent directory
//#include "DarkMode/UAHMenuBar.h"  // PapyrusPlugin modification -- not used
...
// PapyrusPlugin modification -- set UI parameters using values obtained from Notepad++
  DPIManager _dpiManager;
  COLORREF _nppDefaultFgColor;
  COLORREF _nppDefaultBgColor;

  void setDarkModeEnabled(bool enabled) {
    _options.enable = enabled;
    _options.enableMenubar = enabled;
    setDarkMode(enabled, enabled);
  }

  void setNppUIColors(Colors nppDarkModeColors, COLORREF nppDefaultFgColor, COLORREF nppDefaultBgColor) {
    darkCustomizedColors = nppDarkModeColors;
    tCustom.change(darkCustomizedColors);
    g_colorToneChoice = customizedTone;

    _nppDefaultFgColor = nppDefaultFgColor;
    _nppDefaultBgColor = nppDefaultBgColor;
  }
// End of PapyrusPlugin modification
...
// End of PapyrusPlugin modification
  ...
  // PapyrusPlugin modification -- use locally defined UI paramters
	//static COLORREF g_treeViewBg = NppParameters::getInstance().getCurrentDefaultBgColor();
	static COLORREF g_treeViewBg {};
...
// End of PapyrusPlugin modification
    ...
    // PapyrusPlugin modification -- use locally defined UI paramters
		...
		ListView_SetTextColor(hwnd, _nppDefaultFgColor);
		ListView_SetTextBkColor(hwnd, _nppDefaultBgColor);
		ListView_SetBkColor(hwnd, _nppDefaultBgColor);
    ...
    // PapyrusPlugin modification -- use locally defined UI paramters
		...
		TreeView_SetTextColor(hwnd, _nppDefaultFgColor);
		TreeView_SetBkColor(hwnd, _nppDefaultBgColor);
...
// End of PapyrusPlugin modification
    ...
    // PapyrusPlugin modification -- use locally defined UI paramters
		...
		COLORREF bgColor = _nppDefaultBgColor;
