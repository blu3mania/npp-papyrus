...
//generic_string folderBrowser(HWND parent, const generic_string & title = TEXT(""), int outputCtrlID = 0, const TCHAR *defaultStr = NULL);  // PapyrusPlugin modification -- not used
//generic_string getFolderName(HWND parent, const TCHAR *defaultDir = NULL);  // PapyrusPlugin modification -- not used
...
//std::wstring s2ws(const std::string& str);  // PapyrusPlugin modification -- not used
//std::string ws2s(const std::wstring& wstr);  // PapyrusPlugin modification -- not used
