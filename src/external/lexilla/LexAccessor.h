...
#include <string>  // PapyrusPlugin modification -- added to solve "string" definition issue

#include "ILexer.h"  // PapyrusPlugin modification -- proper header reference for IDocument
